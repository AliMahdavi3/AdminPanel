...
export const validationSchema = Yup.object().shape({
        user_id : Yup.number().typeError("فقط عدد استفاده کنید").required("لطفا این قسمت را پر کنید"),
        product_id : Yup.number().typeError("فقط عدد استفاده کنید").required("لطفا این قسمت را پر کنید"),
        color_id : Yup.number().typeError("فقط عدد استفاده کنید"),
        guarantee_id : Yup.number().typeError("فقط عدد استفاده کنید"),
        count : Yup.number().typeError("فقط عدد استفاده کنید").required("لطفا این قسمت را پر کنید"),
});
