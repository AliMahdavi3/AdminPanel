...
export const useHasPermissions = (pTitle) => {
        ...
        return  isAdmin     ||      (typeof(pTitle) === "object"   ?   
        hasOneOfPerm(permissions,   pTitle)     :    permissions.findIndex(p=>p.title.includes(pTitle)) > -1)
